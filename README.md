...
This is an OCR module using the for [CodeProject.AI Server](https://github.com/codeproject/CodeProject.AI-Server). The actual module itself is downloadable via the CodeProject.AI Server's dashboard.
